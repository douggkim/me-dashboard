...
class TestEmailFailureSensor:
    ...
    @mock.patch("src.sensors.email_failure_sensor.send_email_notification")
    def test_email_failure_sensor_with_step_failure(self, mock_send_email):
        ...
        with mock.patch.dict(os.environ, {
            ...
            with mock.patch("dagster._core.definitions.run_status_sensor_definition.RunFailureSensorContext.get_step_failure_events", return_value=[mock_step_event]):
                email_failure_sensor(context)
